...
const content: Content = {
  mission: {
    ...
    image:
      "https://images.unsplash.com/photo-1623697899817-2e067e4a4036?q=80&w=1865&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  vision: {
      ...
      <div className={styles.header}>
        ...
        <h1 className={styles.heading}>
          ...
          <span className={styles.highlight}>
            LOVE, SERVICE, WORSHIP AND FELLOWSHIP
          </span>
        </h1>
